...
vim.keymap.set('n', '<leader>tr', ':set relativenumber!<CR>', { noremap = true, silent = true, desc = '[T]oggle [r]elative line numbers' })
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        clangd = {
          capabilities = capabilities_blink,
          cmd = {
            'clangd',
      ...
      require('mason-lspconfig').setup {
        ...
        handlers = {
          function(server_name)
            ...
            server.capabilities = vim.tbl_deep_extend('force', {}, capabilities_blink, server.capabilities or {})
